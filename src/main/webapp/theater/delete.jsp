    ...
    <DIV style='display: table-cell; vertical-align: middle;'>
      <FORM name='frm' method='POST' action='./delete.do'>
        ...
        <fieldset class='fieldset_basic'>
          <ul>
            <li class='li_none' style="font-weight: bold;">삭제될 지역 이름: ${theaterVO.area }</li>
            <li class='li_none' style="font-weight: bold;">삭제될 극장 이름: ${theaterVO.theater }</li>
            <li class='li_none'>삭제하면 복구 할 수 없습니다.<br> 
                                    삭제를 진행 하시겠습니까?
            </li>
            <li class='li_right'>
