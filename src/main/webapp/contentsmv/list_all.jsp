        ...
        <c:forEach var="contentsmvVO" items="${list }">
          ...
          <tr> 
            ...
            <td style='text-align: center;'>
              <a href="./update.do?contentsmvno=${contentsmvno}"><img src="./images/update.png" title="수정" border='0'/></a>
              <a href="./delete.do?contentsmvno=${contentsmvno}"><img src="./images/delete.png" title="삭제"  border='0'/></a>
            </td>
          </tr>
        </c:forEach>
