...
<DIV class='container' style='width: 100%;'> 
  ...
  <DIV class='top_menu'>
    ...
    <NAV class='top_menu_list'>
      ...
      <A class='menu_link'  href='${root}/eventgrp/list.do'>이벤트 그룹</A> <span class='top_menu1'> | </span>    
      <A class='menu_link'  href='${root}/contents/list_all.do'>전체글</A> <span class='top_menu1'> | </span>    
      <A class='menu_link'  href='${root}/attachfile/list.do'>전체 이미지</A> <span class='top_menu1'> | </span>  
  ...
  <DIV class="row" style='margin-top: 2px;'>
    <DIV class="col-md-2"> <!-- 메뉴 출력 컬럼 -->
      ...
      <%-- <c:import url="/eventgrp/list_index_left.do" /> --%> 
    </div>
