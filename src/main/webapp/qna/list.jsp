...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE style='float: right;'>
    <A href="javascript:location.reload();">새로고침</A>
      ...
      <A href='./create.do?qnagrpno=${qnagrpVO.qnagrpno }'>등록</A> 
  </ASIDE> 
        ...
        <c:forEach var="qnaVO" items="${list }">
          ...
          <tr> 
            ...
            <td style='text-align: center;'>
              <a href="./update.do?qnano=${qnano}&qnagrpno=${qnagrpVO.qnagrpno}"><img src="./images/update.png" title="수정"></a>
              <a href="./delete.do?qnano=${qnano}&qnagrpno=${qnagrpVO.qnagrpno}"><img src="./images/delete.png" title="삭제"></a>
            </td>
          </tr>
        </c:forEach>
